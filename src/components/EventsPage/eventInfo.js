export const eventInfo = [
  {
    eventName: 'HackNITR',
    eventDescriptions: [
      'Suspendisse at est libero. Curabitur nec dolor rutrum, lacinia metus sed, euismod leo. Donec tincidunt sem vel justo mollis ornare. Suspendisse lobortis aliquam libero eget mollis. Fusce in nisl est. ',
  ...
  },
  {
    ...
    eventDescriptions: [
      'Ut ultricies augue et urna feugiat, lobortis rutrum velit auctor. Curabitur volutpat diam nisl, convallis rutrum sem aliquet vel. Duis in lectus id nibh egestas dictum. Sed ac enim non. ',
